        ...
        <div class="slide">
          <div class="preview">
            <div class="preview__img-wrap">
              <div class="preview__img overlay-effect" style="background-image: url(img/project1.png);"></div>
...
<p>Financing & Insurance Solutions Provider</p>
          ...
          <h3 class="slide__title" id="pro1">Paydraft</h3>
        </div>
        <div class="slide">
          <div class="preview">
            <div class="preview__img-wrap">
...
<button class="btn btn-view" onclick="window.open('https://github.com/olumide95/3D-Point-cloud-Visualizer')">View Project</button>
    ...
    <script type="text/javascript">
     $( ".slide__title" ).click(function() {
      $( ".slidenav__preview" ).click();
    });
    </script>
	</body>
</html>
