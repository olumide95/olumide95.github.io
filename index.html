...
Ølumide">Ølumide</h1>
		<span class="sub" style="font-weight: bolder;">Olugbemiro</span>
	</div>
				...
				<div 
					id="gl" 
					data-imageOriginal="img/canyon.jpg" 
					data-imageDepth="img/canyon-map.jpg" 
				...
				<div class="frame__content ">Ø</div>
        <div class=" rotate"><a style="color: white" class="typewrite" data-period="2000" data-type="[ &quot;Hi, I'm Olumide.&quot;, &quot;I design and develop web apps.&quot;]"><span class="wrap"></span></a></div>
...
<br>
    ...
    window.onload = function() {
        ...
        css.type = "text/css";
        css.innerHTML = ".typewrite > .wrap { border-right: 0.08em solid #fff; color:white;font-size: 50px;font-family: 'Anonymous Pro', monospace;}";
